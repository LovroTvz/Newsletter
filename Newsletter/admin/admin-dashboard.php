...
if(isset($_POST) && count($_POST) > 0){
   ...
   if(!is_null($db_conn)){
    ...
    $insert = $db_conn->prepare("INSERT INTO articles (title, excerpt, content, author,pictures) values (?,?,?,?,?)");
    
    $insert->execute([$title, $postDescr, $text, $_SESSION['current_admin']->name, $path]);
   }
}
?>
<!DOCTYPE html>
...
<aside>
    <nav>
        ...
        <main class="container">
            <form action="" method="post" name="Database" class="savePost">
                ...
                <input type="text" name="postDesc" id="postDesc">
                ...
                <textarea name="postText" id="postText"></textarea><br>
